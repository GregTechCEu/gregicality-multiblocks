package gregicality.machines.common.metatileentities.multiblockpart;
...
public class MetaTileEntityParallelHatch extends MetaTileEntityMultiblockPart implements IMultiblockAbilityPart<IParallelHatch>, IParallelHatch {
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gcy_multiblocks.machine.parallel_hatch.tooltip", this.maxParallel));
    }
