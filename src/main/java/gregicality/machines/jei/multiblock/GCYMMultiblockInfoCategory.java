package gregicality.machines.jei.multiblock;
...
public class GCYMMultiblockInfoCategory implements IRecipeCategory<MultiblockInfoRecipeWrapper> {
    ...
    public static void registerRecipes(IModRegistry registry) {
        registry.addRecipes(multiblockRecipes.values(), String.format("%s:multiblock_info", GregicalityMachines.MODID));
    }
    ...
    public String getModName() {
        return GregicalityMachines.MODID;
    }
